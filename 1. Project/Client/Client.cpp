...
#include <Dll1\dll_func.h>
#ifdef _DEBUG
#pragma comment(lib, "Dll1\\Dll1_debug.lib")
#else
#pragma comment(lib, "Dll1\\Dll1.lib")
#endif
                     ...
                     _In_ int       nCmdShow)
{
    ...
    HMODULE hLib = LoadLibrary(L"Dll1_debug.dll");

    MUL mul = (MUL)GetProcAddress(hLib, "Mul");
    int c = mul(5, 5);
